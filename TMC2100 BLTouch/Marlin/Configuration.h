...
#define STRING_CONFIG_H_AUTHOR "(philcal)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "Tevo Flash"
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 120    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT 120    // Y point for Z homing when homing all axis (G28).
#endif
